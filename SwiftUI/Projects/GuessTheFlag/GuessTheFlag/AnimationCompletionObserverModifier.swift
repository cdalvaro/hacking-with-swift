...
//  Animations
//
//  Created by Carlos Álvaro on 2/7/22.
//

import Foundation
import SwiftUI

// Source: https://www.avanderlee.com/swiftui/withanimation-completion-callback/
...
struct AnimationCompletionObserverModifier<Value>: AnimatableModifier where Value: VectorArithmetic {
    ...
    /// This vaue is set to the `oldValue` until the animation completes.
