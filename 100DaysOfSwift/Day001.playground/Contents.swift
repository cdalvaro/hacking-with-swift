...
// Swift is what’s known as a type-safe language, which means that
...
// If you want you can be explicit about the type of your data
// rather than relying on Swift’s type inference, like this:
