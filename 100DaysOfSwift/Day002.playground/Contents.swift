...
// This last line makes the array: it starts and ends with brackets,
...
// Because they are unordered, you can’t read values from a set using numerical positions
...
// where each item has a precise position or name, you should use a tuple:
...
// 4. Tuples are fixed in size, and you can attach names to each of their items.
...
// 7. You can attach raw values to enums so they can be created from integers or strings,
